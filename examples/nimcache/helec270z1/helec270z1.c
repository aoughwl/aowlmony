...
extern void write_2_syn1lfpjv(FILE* f_8, NI64 x_0);
extern void nimFlushStdStreams(void);
LongString_0_sysvq0asl const strlit_0_I4170858454456741928_helec270z1 = {
  .fullLen_0 = IL64(18), .rc_0 = IL64(0), .capImpl_0 = IL64(0), .data_0 = "hello from aifmony"}
;
NB8 X60QiniGuard_0_helec270z1;
NI32 cmdCount;
NC8** cmdLine;
NC8** nimEnviron;
void X60Qini_0_helec270z1(void){
  if (X60QiniGuard_0_helec270z1){
    return;}
  X60QiniGuard_0_helec270z1 = NIM_TRUE;
  X60Qini_0_sysvq0asl();
  X60Qini_0_syn1lfpjv();
  write_0_syn1lfpjv(stdout, (string_0_sysvq0asl){
    .bytes_0 = 7359004302589126910ull, .more_0 = (&strlit_0_I4170858454456741928_helec270z1)}
  );
  write_7_syn1lfpjv(stdout, (NC8)'\012');
  write_2_syn1lfpjv(stdout, ((NI64)(IL64(6) * IL64(7))));
  write_7_syn1lfpjv(stdout, (NC8)'\012');}
NI32 main(NI32 X60Qargc_0_helec270z1, char** X60Qargv_0_helec270z1, char** X60Qenvp_0_helec270z1){
  cmdCount = X60Qargc_0_helec270z1;
  cmdLine = ((NC8**)X60Qargv_0_helec270z1);
  nimEnviron = ((NC8**)X60Qenvp_0_helec270z1);
  X60Qini_0_helec270z1();
  nimFlushStdStreams();
  return IL64(0);}
